...
//            paddingToBottom.constant = 60
            containerHeight.constant = CGFloat(self.height)
            paddingToLeft.constant = CGFloat(self.leftPadding)
            paddingToRight.constant = CGFloat(self.rightPadding)
        case .tv:
            print("tvOS style UI")
        default:
...
extension YBTextPicker : UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        {
            chkImage = #imageLiteral(resourceName: "checkbox")
        }else{
            chkImage = #imageLiteral(resourceName: "enter amount screen")
        }
