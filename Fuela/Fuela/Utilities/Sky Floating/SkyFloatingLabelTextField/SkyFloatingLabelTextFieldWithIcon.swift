...
open class SkyFloatingLabelTextFieldWithIcon: SkyFloatingLabelTextField {
    ...
    @IBInspectable
    dynamic open var iconColor: UIColor = UIColor.lightGray {
        didSet {
    ...
    */
    ...
    fileprivate func updateImageViewTintColor() {
        if !isEnabled {
            ...
            iconImageView.tintColor = (editingOrSelected  || !super.text!.isEmpty) ? selectedIconColor : iconColor
        }
    }
    ...
    fileprivate func updateIconLabelColor() {
        if !isEnabled {
            ...
            iconLabel?.textColor = (editingOrSelected  || !super.text!.isEmpty) ? selectedIconColor : iconColor
        }
    }
