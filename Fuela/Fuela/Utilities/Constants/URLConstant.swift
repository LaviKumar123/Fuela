...
//  Copyright © 2019 Alcax Technologies. All rights reserved.
//
...
class URLConstant {
    ...
    static let termsCondition           = "term_condition"
    static let signUp                   = "user_registration"
    static let login                    = "login"
    static let forgotPassword           = "forgot_password"
    static let changePassword           = "changePassword"
    static let logout                   = "user/logout"
    static let userWorkDetail           = "userWorkDetail"
    static let usersIncomedetails       = "usersIncomedetails"
    ...
    static let getWorkDetails           = "getWorkDetails"
    static let getIncomeDetails         = "getIncomeDetails"
