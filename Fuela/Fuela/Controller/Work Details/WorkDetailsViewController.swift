...
//            errorMessage = "Please enter month of experience."
        ...
        }else if (self.contactNumberTextField.text!.length < 10) || (self.contactNumberTextField.text!.length > 15){
            errorMessage = "Contact number length should be between 10 to 15 digits."
        }else {
            return true
        }
